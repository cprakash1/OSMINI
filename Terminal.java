...
class Terminal {
    ...
    public static void Dir(String name, String pa) {
        ...
        if (directory.exists()) {
            ...
            JOptionPane.showMessageDialog(null, "Directory already exists " + name, "InfoBox: " + "Hello..!!",
            ...
            if (success) {
                ...
                JOptionPane.showMessageDialog(null, "Successfully created new directory..!!!! " + dir,
                        "InfoBox: " + "Hello..!!", JOptionPane.INFORMATION_MESSAGE);
            } else {
                System.out.printf("Failed to create new directory: %s%n", dir);
                JOptionPane.showMessageDialog(null, "Failed to create new directory..!!!! " + dir,
                        "InfoBox: " + "Hello..!!", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    }
    ...
    public static void Fil(String name, String pa) {
        ...
        try {
            ...
            if (directory.exists()) {
                ...
                JOptionPane.showMessageDialog(null, "File already exists...!!! " + dir, "InfoBox: " + "Hello..!!",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                ...
                if (success) {
                    ...
                    JOptionPane.showMessageDialog(null, "Successfully created new file...!!! " + dir,
                            "InfoBox: " + "Hello..!!", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    System.out.printf("Failed to create new file: %s%n", dir);
                    JOptionPane.showMessageDialog(null, "Failed to create new file...!!! " + dir,
                            "InfoBox: " + "Hello..!!", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        } catch (IOException e) {
        ...
        if (use.startsWith("ls")) {
            ...
            for (int i = 0; i < listOfFiles.length; i++) {
                if (name.startsWith(listOfFiles[i].getName())) {
                    ...
                    JOptionPane.showMessageDialog(null, "Successfully Deleted " + name, "InfoBox: " + "Hello..!!",
                            JOptionPane.INFORMATION_MESSAGE);
                }
            }
